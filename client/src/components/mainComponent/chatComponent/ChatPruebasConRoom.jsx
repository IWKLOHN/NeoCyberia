...
export const ChatPruebasConRoom = ({ handleShowProfile, users, loggedUser, loggedUserId }) => {
                        ...
                        <ul>
                            {
                                allMessages.map((message, i) => (
                                    ...
                                    <li key={i} className={`${message.from === loggedUserId ? styles.senderStyle : styles.receivedStyles}
                                                            ${message.sender && message.sender._id === loggedUserId ? styles.senderStyle : styles.receivedStyles}
                                                            ${message.recipient === loggedUserId ? styles.recievedStyles : styles.senderStyle}`}>
